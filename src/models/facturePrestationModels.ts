...
// FacturePrestations.belongsToMany(Prestation, { through: 'Prestation_FacturePrestation', foreignKey: "factureId" });
// Prestation.belongsToMany(FacturePrestations, { through: 'Prestation_FacturePrestation', foreignKey: "prestationId" });
